...
namespace MVC5.Controllers
{
  ...
  public class AccountController : Controller
  {
    ...
    //
    // GET: /Account/ManagerAccountLogin
    [AllowAnonymous]
    public ActionResult ManagerAccountLogin(string returnUrl)
    {
      ViewBag.ReturnUrl = returnUrl;
      return View();
    }
    ...
    //
    // POST: /Account/ManagerAccountLogin
    [HttpPost]
    [AllowAnonymous]
    [ValidateAntiForgeryToken]
    public ActionResult ManagerAccountLogin(AdminViewModel model, string returnUrl)
    {
      return View();
    }
