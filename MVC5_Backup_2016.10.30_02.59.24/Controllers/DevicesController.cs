...
namespace MVC5.Controllers
{
  public class DevicesController : Controller
  {
    ...
    [Authorize]
    public async Task<ActionResult> GenerateAgingCurveByInput(int? id, FormCollection form)
    {
      Device device = await _dbContext.Devices.FindAsync(id);
      ViewBag.name = "degradation.jpg";

      int input1 = Convert.ToInt32(form["input1"].ToString());
      int input2 = Convert.ToInt32(form["input2"].ToString());
      int input3 = Convert.ToInt32(form["input3"].ToString());
      int input4 = Convert.ToInt32(form["input4"].ToString());
